  ...
  beforeEach(function(){
    ...
    function iteratorFunction() {
      return {
        next: function() {
          return {
            // compute done before shifting so that the last user has done: false
            // Originally from https://github.com/LeopoldTal/es6katas/blob/master/iterator/exampleUsage.js
